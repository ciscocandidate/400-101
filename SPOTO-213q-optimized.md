...
B. It is generated by each ABR and forwarded in n o n -stub areas.
...
B. TA CASCS+ authentication uses an RSA server to authenticate users.
...
A. EIGRP can summarize routes at the c1assful network boundary
